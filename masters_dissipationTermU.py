...
This file is used to calculate the rate of TKE dissipation using the inertial subrange method and the PSD of the horizontal velocity.
...
#least-squares minimization to remove noisefloor
...
# save to a csv file
eps_df.to_csv(file_save_path+"epsU_terms_sonic"+mNode+"_MAD_k_UoverZbar.csv") #this will save the file and name it based on the sonic number you are running it for
